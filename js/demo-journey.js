/* Template Factory - Aaron Bonk Home Repair live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-bonk-yorbalinda/';
  var LS_CHANGES = 'tf_bonk_change_log_v1';
  var LS_PURCHASED = 'tf_bonk_purchased_v1';
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Aaron at Aaron Bonk Home Repair. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Aaron at Aaron Bonk Home Repair. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Aaron Bonk Home Repair. Hang tight.',
        delay,
        function () {
